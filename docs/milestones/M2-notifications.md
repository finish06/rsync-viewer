...
| Webhook Notification Service | specs/webhook-service.md | SPECCED | Spec complete, plan + TDD next |
...
| cycle-2 | Webhook Service | IN_PROGRESS | Spec done, starting plan + TDD |
